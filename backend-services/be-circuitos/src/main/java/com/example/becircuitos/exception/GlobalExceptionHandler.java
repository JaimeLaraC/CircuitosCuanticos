package com.example.becircuitos.exception;

import com.example.becircuitos.dto.ErrorResponseDto; // Adjust if package is different
...
import org.springframework.web.client.HttpStatusCodeException; // Parent for HttpClientErrorException and HttpServerErrorException
import org.springframework.web.context.request.WebRequest;
import jakarta.persistence.EntityNotFoundException; // If used more broadly
...
public class GlobalExceptionHandler {
    ...
    // This can catch errors from RestTemplate if they are not caught by UserManagementClient
    ...
    public ResponseEntity<ErrorResponseDto> handleHttpStatusCodeException(
        ...
        ErrorResponseDto errorResponse = new ErrorResponseDto(
                ...
                ex.getStatusText(), // Or a more generic "External Service Error"
    ...
    @ExceptionHandler(EntityNotFoundException.class) // Example if used
